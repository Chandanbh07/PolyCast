...
export default function MarketDetail() {
  ...
  if (!market) {
    return (
      <div className="mx-auto max-w-7xl px-4 py-20 text-center sm:px-6">
        ...
        <Link to="/markets" className="mt-3 inline-block text-sm text-signal-300 hover:text-signal-200">
          Back to markets
        </Link>
      </div>
    );
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
      <Link to="/markets" className="flex items-center gap-1.5 text-sm text-mist-400 transition-colors hover:text-mist-100">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="glass relative overflow-hidden rounded-3xl p-6">
            ...
            <div className="relative mt-4 flex items-start justify-between gap-4">
              <div>
                <h1 className="font-display text-2xl font-semibold leading-snug tracking-[-0.02em] text-mist-50 sm:text-3xl">
                  {market.title}
                </h1>
                <p className="mt-2 text-sm text-mist-300 leading-relaxed">{market.description}</p>
              </div>
          ...
          {address && (yesQty > 0 || noQty > 0) && (
            <div className="glass rounded-3xl p-5">
              ...
              <div className="mt-3 flex gap-4">
                <div className="flex-1 rounded-xl border border-yes-500/20 bg-yes-500/10 p-3">
                  <p className="text-xs text-mist-400">Yes shares</p>
                  <p className="font-mono-nums text-lg font-semibold text-yes-400">{yesQty}</p>
                </div>
                <div className="flex-1 rounded-xl border border-no-500/20 bg-no-500/10 p-3">
          ...
          <SectionCard icon={ScrollText} title="Resolution criteria">
            <p className="text-sm text-mist-300 leading-relaxed">{market.resolutionDescription}</p>
          </SectionCard>
