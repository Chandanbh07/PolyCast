 ...
 * palette so it quietly previews the product (green/red tension, indigo brand)
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      <motion.div
        ...
        style={{ background: "radial-gradient(circle, rgba(47,181,131,0.16), transparent 70%)" }}
        animate={{ x: [0, 30, -10, 0], y: [0, 20, 10, 0] }}
        transition={{ duration: 22, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute right-[-8%] top-[5%] size-[380px] rounded-full blur-3xl"
        style={{ background: "radial-gradient(circle, rgba(221,79,104,0.14), transparent 70%)" }}
        animate={{ x: [0, -24, 12, 0], y: [0, 16, -14, 0] }}
        transition={{ duration: 26, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute left-[30%] top-[20%] size-[460px] rounded-full blur-3xl"
        style={{ background: "radial-gradient(circle, rgba(217,154,52,0.18), transparent 70%)" }}
